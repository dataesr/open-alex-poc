...
const GROUP_BYS = ['publication_year', 'concepts.id', 'authorships.author.id', 'authorships.institutions.country_code', 'primary_location.source.id', 'authorships.institutions.id'];
      ...
      {(!error && !isLoading && data && Object.keys(data)?.length > 0) && (
        <>
          ...
          <Container as="section">
            ...
            />
            <BarChart data={data?.['primary_location.source.id']} type="bar" slice={15} categoriesText="Top sources" />
            <hr className="fr-col-xs-10 fr-col-7 fr-my-6w" />
            <GraphHeader
              iconName="ri-bar-chart-fill"
